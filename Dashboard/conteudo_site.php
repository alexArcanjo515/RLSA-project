...
if (isset($_POST['salvar'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO perfil (nome_empresa, email, telefone, endereco, sobre, Datacriacao, missao, estrategia, anosexperiencia, totaldeprojectos, logotipo) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssssssssss", $nome_empresa, $email, $telefone, $endereco, $sobre, $Datacriacao, $missao, $estrategia, $anosexperiencia, $totaldeprojectos, $logotipo_path);
                ...
                <div class="card-body">
                    <div class="basic-form">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="infrastructure" name="infrastructure" class="form-control h-150px" rows="6">
...
Os serviços de datacenter da TAC são projetados para garantir a máxima disponibilidade e uptime. Nossos datacenters utilizam sistemas de energia redundante, resfriamento avançado e monitoramento contínuo para minimizar qualquer risco de interrupção. Com nossa infraestrutura robusta, você pode confiar que suas operações continuarão funcionando sem problemas, mesmo em situações imprevistas.
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="cost-reduction" name="cost-reduction" class="form-control h-150px" rows="6">
...
Na TAC, sabemos que cada empresa é única. Nossas soluções de desenvolvimento de aplicações são personalizadas para atender às necessidades específicas de cada cliente. Desde sistemas internos de gestão até plataformas voltadas ao consumidor final, desenvolvemos aplicativos escaláveis que crescem junto com o seu negócio. Isso significa que, à medida que sua empresa expande, suas soluções de TI acompanham o ritmo, sem a necessidade de constantes reconfigurações ou substituições.
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="integracao-sistemas" name="integracao-sistemas" class="form-control h-150px"
                                rows="6" required>
Em muitas empresas, o maior desafio é fazer com que diferentes sistemas de software "conversem" entre si. A TAC oferece serviços especializados de integração de sistemas, conectando todas as suas ferramentas e plataformas em um ecossistema unificado. Isso melhora a produtividade e elimina retrabalhos, pois informações cruciais fluem automaticamente entre departamentos e sistemas, reduzindo falhas e economizando tempo.
                        ...
                        <div class="form-group">
                            <label for="seguranca-confiabilidade">Segurança e Confiabilidade em Primeiro Lugar</label>
...
Automatizar processos é essencial para reduzir custos operacionais e minimizar erros humanos. Com as soluções da TAC, automatizamos fluxos de trabalho críticos, permitindo que sua equipe se concentre em tarefas estratégicas, enquanto sistemas automáticos cuidam das operações repetitivas. Isso não só melhora a eficiência, mas também promove maior precisão nas operações diárias.
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="suporte-tecnico" name="suporte-tecnico" class="form-control h-150px" rows="6"
                                required>
...
- Conformidade e Auditoria: Mantemos sua empresa em conformidade com os regulamentos de segurança mais exigentes.
                        ...
                        <div class="form-group">
                            <label for="noc-desempenho">NOC (Network Operations Center): Garantia de Desempenho e
                                Estabilidade</label>
                            <textarea id="noc-desempenho" name="noc-desempenho" class="form-control h-150px" rows="6"
                                required>
...
Nossas soluções de rede garantem conectividade contínua, com monitoramento 24/7 e capacidade de resposta a incidentes em tempo real, melhorando a performance e reduzindo o risco de interrupções que podem impactar os negócios.
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="desenvolvimento-agil" name="desenvolvimento-agil" class="form-control h-150px"
                                rows="6" required>
...
Incorporamos automação e inteligência artificial para melhorar a tomada de decisões com insights baseados em dados, promovendo operações mais inteligentes e ágeis que liberam as equipes para se concentrarem em atividades estratégicas.
    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Soluções da TAC Contra Ciberataques</h4>
                    <div class="basic-form">

                        <!-- Monitoramento Proativo 24/7 -->
                        <div class="form-group">
                            <label for="monitoramento-proativo">Monitoramento Proativo 24/7</label>
                            <textarea id="monitoramento-proativo" name="monitoramento-proativo"
                                class="form-control h-150px" rows="6" required>
A TAC oferece monitoramento contínuo através do SOC (Security Operations Center), garantindo que os sistemas das empresas estejam sempre sob vigilância, com detecção e resposta a ameaças em tempo real, 24 horas por dia, 7 dias por semana.
                        </textarea>
                        </div>
                        <br>
                        ...
                        <div class="form-group">
                            <label for="resposta-incidentes">Resposta Rápida a Incidentes</label>
                            <textarea id="resposta-incidentes" name="resposta-incidentes" class="form-control h-150px"
                                rows="6" required>
Nossa equipe especializada responde a incidentes de segurança com rapidez e eficiência, contendo ataques cibernéticos e restaurando a normalidade o mais rápido possível, minimizando os danos e assegurando a continuidade dos negócios.
                        </textarea>
                        </div>
                        <br>

                        <!-- Soluções de Defesa em Camadas -->
                        <div class="form-group">
                            <label for="defesa-camadas">Soluções de Defesa em Camadas</label>
                            <textarea id="defesa-camadas" name="defesa-camadas" class="form-control h-150px" rows="6"
                                required>
Implementamos uma defesa cibernética em camadas, combinando firewalls avançados, segmentação de rede, sistemas de prevenção contra intrusões (IPS) e criptografia para garantir que as ameaças sejam neutralizadas antes que causem qualquer dano.
                        </textarea>
                        </div>
                        <br>
                        ...
                        <div class="form-group">
                            <label for="treinamento-funcionarios">Educação e Treinamento de Funcionários</label>
                            <textarea id="treinamento-funcionarios" name="treinamento-funcionarios"
                                class="form-control h-150px" rows="6" required>
Capacitamos os funcionários das empresas com treinamentos regulares em boas práticas de segurança cibernética, ajudando a prevenir ataques originados por erros humanos, como phishing e engenharia social.
                        </textarea>
                        </div>
                        <br>
                        ...
                        <div class="form-group">
                            <label for="auditorias-conformidade">Auditorias e Conformidade</label>
                            <textarea id="auditorias-conformidade" name="auditorias-conformidade"
                                class="form-control h-150px" rows="6" required>
Realizamos auditorias detalhadas de segurança cibernética para garantir que as empresas estejam em conformidade com as regulamentações, como LGPD e ISO 27001, identificando vulnerabilidades e fornecendo soluções para fortalecer suas defesas.
                        </textarea>
                        </div>
                        <br>
                        ...
                        <!-- Botões de Ação -->
                        <div class="form-group">
                            <input type="submit" class="btn btn-dark" name="salvardadosegurancacibernetica"
                                value="Salvar Dados de Segurança">
                            <input type="reset" class="btn btn-danger" value="Limpar">
                        </div>
                    </div>
                </div>
